...
describe PropertiesController do
  ...
  describe "index" do
    before do
      Property.create!(name: 'Baked Potato w/ Cheese')
      Property.create!(name: 'Garlic Mashed Potatoes')
      Property.create!(name: 'Potatoes Au Gratin')
      Property.create!(name: 'Baked Brussel Sprouts')
